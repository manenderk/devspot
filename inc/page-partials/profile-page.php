<div class="text-center mt-lg">
    ...
    <div class="h6 font-weight-300"><i class="ni location_pin mr-2"></i>New Delhi, India</div>
    <div class="h6 mt-4"><i class="ni business_briefcase-24 mr-2"></i>ServiceNow Developer / Web Developer</div>
    <div><i class="ni education_hat mr-2"></i>Bachelor of Technology in Computer Science and Engineering</div>
</div>
<div class="mt-5 py-5 border-top text-center">
    <div class="row justify-content-center">
    <div class="col-lg-9">
        <p>I am an experienced ServiceNow and Web developer. I am Currently working as ServiceNow CSA specialist. I have expertise in ServiceNow ITSM as well as in some web technologies like CakePHP, Wordpress, PHP, jQuery and MySQL. I have good skills in UI/UX and specialized in logic and algorithm building. </p>
    </div>
    </div>
</div>
