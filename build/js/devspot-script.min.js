...
$(function(){var e=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),n=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),i=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");function t(e,n,i,t){var a="rgb("+e+","+n+","+i+")",r="#"+t,s="#fff",l=parseInt(e),o=parseInt(n),c=parseInt(i),u=Math.sqrt(l*l*.299+o*o*.587+c*c*.114);u>127.5&&(s="#000"),NaN!=u&&($("#rgb-sample").text(a).css("color",s),$("#hex-sample").text(r).css("color",s))}function a(e){var n=e.toString(16);return 1==n.length?"0"+n:n}function r(e){$(".color-sample").css("background-color","#"+e)}function s(){var e=$("#select-aspect-ratio").children("option:selected").val(),n=$("#custom-aspect-ratio").val();return""!=e?e:n.replace(":","*").replace(/ /g,"")}e.click(function(){var e=$(this).siblings("ul.sub-menu");return e.is(":visible")||n.hide(),e.slideToggle("500"),!1}),i.click(function(){var e=$(this).attr("href");window.location=e}),$(window).scroll(function(){n.is(":visible")&&$(n).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var e="";e="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var n={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:e,type:"post",data:n,success:function(e){e=JSON.parse(e),$("#output-resource").val(e.minified_resource),$("#minify-description").html("Original Size: "+e.original_size/1e3+"KB<br>Minified Size: "+e.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var e,n,i,s=$("#color-rgb-red").val(),l=$("#color-rgb-green").val(),o=$("#color-rgb-blue").val(),c="";""!=s&&""!=l&&""!=o&&(e=parseInt(s),n=parseInt(l),i=parseInt(o),c=a(e)+a(n)+a(i),$("#color-hex").val(c)),r(c),t(s,l,o,c)}),$("#color-hex").keyup(function(){var e=$("#color-hex").val();if(""!=e){var n=function(e){e=e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(e,n,i,t){return n+n+i+i+t+t});var n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return n?{r:parseInt(n[1],16),g:parseInt(n[2],16),b:parseInt(n[3],16)}:null}(e);$("#color-rgb-red").val(n.r),$("#color-rgb-green").val(n.g),$("#color-rgb-blue").val(n.b)}r(e),t(n.r,n.g,n.b,e)}),$("#dimension-w, #dimension-h").keyup(function(){var e=$("#dimension-w").val(),n=$("#dimension-h").val();if(""!=e&&""!=n){var i=function(e,n){return function e(n,i){return 0==i?n:e(i,n%i)}(e,n)}(parseInt(e),parseInt(n));$("#calculated-aspect-ratio").text(parseInt(e)/i+":"+parseInt(n)/i)}}),$("#dimension-w1").keyup(function(){var e=$("#dimension-w1").val(),n=s();if(""!=n){var i=n.split("*")[0],t=n.split("*")[1];$("#dimension-h1").val(parseInt(e)*parseInt(t)/parseInt(i))}}),$("#dimension-h1").keyup(function(){var e=$("#dimension-h1").val(),n=s();if(""!=n){var i=n.split("*")[0],t=n.split("*")[1];$("#dimension-w1").val(parseInt(e)*parseInt(i)/parseInt(t))}}),$("#dimension-w2").keyup(function(){var e=parseInt($("#dimension-w2").val()),n=parseInt($("#dimension-w1").val()),i=parseInt($("#dimension-h1").val());$("#dimension-h2").val(e*i/n)}),$("#dimension-h2").keyup(function(){var e=parseInt($("#dimension-h2").val()),n=parseInt($("#dimension-w1").val()),i=parseInt($("#dimension-h1").val());$("#dimension-w2").val(e*n/i)}),$("#shortlink-list").click(function(){$("#shortlink-list-view").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-shortlinks/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(e){var n="";if("success"==e.status){var i="",t=e.message;$.each(t,function(e,n){var t=siteUrl+"/"+n.shortLink;i+='<p><a href="'+t+'">'+t+"</a> - "+n.redirectLink+"</p>"}),$("#shortlink-list-view").html(i)}else n='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+e.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';$("#message-container").html(n)})}),$("#add-shortlink-form").submit(function(e){e.preventDefault();var n=$(this).serialize();$.ajax({url:wpApiSettings.root+"dshortlink/v1/add-shortlink/?_wpnonce="+wpApiSettings.nonce,data:n,type:"post"}).done(function(e){var n="";n="success"==e.status?'<div class="alert alert-success alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Success!!</strong> Shortlink created</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>':'<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+e.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>',$("#message-container").html(n)})})});