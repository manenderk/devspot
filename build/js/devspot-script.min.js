...
window.addEventListener("load",function(){window.wpcc.init({border:"thin",corners:"small",colors:{popup:{background:"#f0edff",text:"#000000",border:"#5e65c2"},button:{background:"#5e65c2",text:"#ffffff"}},fontsize:"small",content:{href:"https://www.deevsi.com/privacy-policy/"}})}),$(function(){var t=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),e=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),n=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");function a(t,e,n,a){var s="rgb("+t+","+e+","+n+")",r="#"+a,o="#fff",i=parseInt(t),l=parseInt(e),c=parseInt(n),d=Math.sqrt(i*i*.299+l*l*.587+c*c*.114);d>127.5&&(o="#000"),NaN!=d&&($("#rgb-sample").text(s).css("color",o),$("#hex-sample").text(r).css("color",o))}function s(t){var e=t.toString(16);return 1==e.length?"0"+e:e}function r(t){$(".color-sample").css("background-color","#"+t)}function o(){var t=$("#select-aspect-ratio").children("option:selected").val(),e=$("#custom-aspect-ratio").val();return""!=t?t:e.replace(":","*").replace(/ /g,"")}t.click(function(){var t=$(this).siblings("ul.sub-menu");return t.is(":visible")||e.hide(),t.slideToggle("500"),!1}),n.click(function(){var t=$(this).attr("href");window.location=t}),$(window).scroll(function(){e.is(":visible")&&$(e).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var t="";t="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var e={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:t,type:"post",data:e,success:function(t){t=JSON.parse(t),$("#output-resource").val(t.minified_resource),$("#minify-description").html("Original Size: "+t.original_size/1e3+"KB<br>Minified Size: "+t.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var t,e,n,o=$("#color-rgb-red").val(),i=$("#color-rgb-green").val(),l=$("#color-rgb-blue").val(),c="";""!=o&&""!=i&&""!=l&&(t=parseInt(o),e=parseInt(i),n=parseInt(l),c=s(t)+s(e)+s(n),$("#color-hex").val(c)),r(c),a(o,i,l,c)}),$("#color-hex").keyup(function(){var t=$("#color-hex").val();if(""!=t){var e=function(t){t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(t,e,n,a){return e+e+n+n+a+a});var e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null}(t);$("#color-rgb-red").val(e.r),$("#color-rgb-green").val(e.g),$("#color-rgb-blue").val(e.b)}r(t),a(e.r,e.g,e.b,t)}),$("#dimension-w, #dimension-h").keyup(function(){var t=$("#dimension-w").val(),e=$("#dimension-h").val();if(""!=t&&""!=e){var n=function(t,e){return function t(e,n){return 0==n?e:t(n,e%n)}(t,e)}(parseInt(t),parseInt(e));$("#calculated-aspect-ratio").text(parseInt(t)/n+":"+parseInt(e)/n)}}),$("#dimension-w1").keyup(function(){var t=$("#dimension-w1").val(),e=o();if(""!=e){var n=e.split("*")[0],a=e.split("*")[1];$("#dimension-h1").val(parseInt(t)*parseInt(a)/parseInt(n))}}),$("#dimension-h1").keyup(function(){var t=$("#dimension-h1").val(),e=o();if(""!=e){var n=e.split("*")[0],a=e.split("*")[1];$("#dimension-w1").val(parseInt(t)*parseInt(n)/parseInt(a))}}),$("#dimension-w2").keyup(function(){var t=parseInt($("#dimension-w2").val()),e=parseInt($("#dimension-w1").val()),n=parseInt($("#dimension-h1").val());$("#dimension-h2").val(t*n/e)}),$("#dimension-h2").keyup(function(){var t=parseInt($("#dimension-h2").val()),e=parseInt($("#dimension-w1").val()),n=parseInt($("#dimension-h1").val());$("#dimension-w2").val(t*e/n)}),$("#shortlink-list").click(function(){$("#shortlink-list-view").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-shortlinks/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(t){var e="";if("success"==t.status){var n="",a=t.message;$.each(a,function(t,e){var a=siteUrl+"/"+e.shortLink;n+='<p><a href="'+a+'" target="_blank">'+a+"</a> - "+e.redirectLink+"</p>"}),$("#shortlink-list-view").html(n)}else e='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';$("#message-container").html(e)})}),$("#add-shortlink-form").submit(function(t){t.preventDefault();var e=$(this).serialize();$.ajax({url:wpApiSettings.root+"dshortlink/v1/add-shortlink/?_wpnonce="+wpApiSettings.nonce,data:e,type:"post"}).done(function(t){var e="";e="success"==t.status?'<div class="alert alert-success alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Success!!</strong> Shortlink created</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>':'<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>',$("#message-container").html(e)})});var i=["#5e72e4","#8965e0","#f5365c","#ffd600","#fb6340","#2dce89","#f3a4b5","#11cdef","#5603ad","#2bffc6"];$("#shortlink-dashboard").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-stats/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(t){var e="";if("success"==t.status){var n=t.message.totalClicks[0].clicks,a=t.message.todayClicks[0].clicks,s=t.message.byClicks,r=t.message.byReferer,o=t.message.byCountry;!function(t){var e=document.getElementById("shortlink-stats-total-clicks-chart").getContext("2d");new Chart(e,{type:"doughnut",data:{datasets:[{data:[t],backgroundColor:["#5e72e4"],label:"Total Clicks"}],labels:["Total Clicks"]},options:{responsive:!0,elements:{center:{text:t,color:"#5e72e4",fontStyle:"Arial",sidePadding:40}}}});$("#shortlink-stats-total-clicks-number").text(t)}(n),function(t){var e=document.getElementById("shortlink-stats-today-clicks-chart").getContext("2d");new Chart(e,{type:"doughnut",data:{datasets:[{data:[t],backgroundColor:["#5e72e4"],label:"Today Clicks"}],labels:["Today Clicks"]},options:{responsive:!0,elements:{center:{text:t,color:"#5e72e4",fontStyle:"Arial",sidePadding:40}}}});$("#shortlink-stats-today-clicks-number").text(t)}(a),function(t){var e=[],n=[],a=[],s="";$.each(t,function(t,r){e.push(r.clicks),n.push(r.shortLink),a.push(i[t%10]),s+="<tr><td>"+(t+1)+"</td><td>"+r.shortLink+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-clicks-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:a}],labels:n},options:{responsive:!0}});$("#shortlink-stats-by-clicks-table tbody").html(s)}(s),function(t){var e=[],n=[],a=[],s="";$.each(t,function(t,r){e.push(r.clicks),n.push(r.referer),a.push(i[t%10]),s+="<tr><td>"+(t+1)+"</td><td>"+r.referer+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-referer-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:a}],labels:n},options:{responsive:!0}});$("#shortlink-stats-by-referer-table tbody").html(s)}(r),function(t){var e=[],n=[],a=[],s="";$.each(t,function(t,r){e.push(r.clicks),n.push(r.country),a.push(i[t%10]),s+="<tr><td>"+(t+1)+"</td><td>"+r.country+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-country-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:a}],labels:n},options:{responsive:!0}});$("#shortlink-stats-by-country-table tbody").html(s)}(o)}else e='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';$("#message-container").html(e)}),$("#jump-to-top").click(function(){$("html, body").animate({scrollTop:0},"slow")});var l=$(window).height();l>$(window).scrollTop()?$("#jump-to-top").hide():$("#jump-to-top").show(),$(window).scroll(function(){l>$(window).scrollTop()?$("#jump-to-top").hide():$("#jump-to-top").show()}),"undefined"!=typeof hljs&&hljs.initHighlightingOnLoad(),$("#format-code").click(function(){var t=$("#code-format-input-code").val(),e=$('.code-format-inputs input[name="input-resource-type"]:checked').val(),n=$('.code-format-inputs input[name="code-format-spacing"]:checked').val(),a=$("#code-format-use-tab").prop("checked");1==a?n=1:a=!1;var s={parser:e,tabWidth:parseInt(n),useTabs:a,singleQuote:!0,printWidth:500,plugins:prettierPlugins};$("html, body").animate({scrollTop:$("#formatted-code-box").offset().top-100},"slow");var r=prettier.format(t,s);$("#formatted-code").val(r),$("#copy-formatted-code").click(function(){$("#formatted-code").select(),document.execCommand("copy")})})});