...
$(function(){var e=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),n=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),i=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");function a(e){var n=e.toString(16);return 1==n.length?"0"+n:n}function o(e){$(".color-sample").css("background-color","#"+e)}e.click(function(){var e=$(this).siblings("ul.sub-menu");return e.is(":visible")||n.hide(),e.slideToggle("500"),!1}),i.click(function(){var e=$(this).attr("href");window.location=e}),$(window).scroll(function(){n.is(":visible")&&$(n).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var e="";e="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var n={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:e,type:"post",data:n,success:function(e){e=JSON.parse(e),$("#output-resource").val(e.minified_resource),$("#minify-description").html("Original Size: "+e.original_size/1e3+"KB<br>Minified Size: "+e.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var e=$("#color-rgb-red").val(),n=$("#color-rgb-green").val(),i=$("#color-rgb-blue").val(),r="";""!=e&&""!=n&&""!=i&&(r=function(e,n,i){return a(e)+a(n)+a(i)}(parseInt(e),parseInt(n),parseInt(i)),$("#color-hex").val(r)),o(r)}),$("#color-hex").keyup(function(){var e=$("#color-hex").val();if(""!=e){var n=function(e){e=e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(e,n,i,r){return n+n+i+i+r+r});var n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return n?{r:parseInt(n[1],16),g:parseInt(n[2],16),b:parseInt(n[3],16)}:null}(e);$("#color-rgb-red").val(n.r),$("#color-rgb-green").val(n.g),$("#color-rgb-blue").val(n.b)}o(e)}),$("#dimension-w, #dimension-h").keyup(function(){var e=$("#dimension-w").val(),n=$("#dimension-h").val();if(""!=e&&""!=n){var i=function(e,n){return function e(n,i){return 0==i?n:e(i,n%i)}(e,n)}(parseInt(e),parseInt(n));$("#calculated-aspect-ratio").text(parseInt(e)/i+":"+parseInt(n)/i)}})});