...
window.addEventListener("load",function(){window.wpcc.init({border:"thin",corners:"small",colors:{popup:{background:"#f0edff",text:"#000000",border:"#5e65c2"},button:{background:"#5e65c2",text:"#ffffff"}},fontsize:"small",content:{href:"https://www.deevsi.com/privacy-policy/"}})}),$(function(){var i=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),n=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),o=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");i.click(function(){var i=$(this).siblings("ul.sub-menu");return i.is(":visible")||n.hide(),i.slideToggle("500"),!1}),o.click(function(){var i=$(this).attr("href");window.location=i}),$(window).scroll(function(){n.is(":visible")&&$(n).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#jump-to-top").click(function(){$("html, body").animate({scrollTop:0},"slow")});var t=$(window).height();t>$(window).scrollTop()?$("#jump-to-top").hide():$("#jump-to-top").show(),$(window).scroll(function(){t>$(window).scrollTop()?$("#jump-to-top").hide():$("#jump-to-top").show()})});