...
!function(t,e){"object"==typeof exports?module.exports=e(t):"function"==typeof define&&define.amd?define([],e):t.LazyLoad=e(t)}("undefined"!=typeof global?global:this.window||this.global,function(t){"use strict";"function"==typeof define&&define.amd&&(t=window);const e={src:"data-src",srcset:"data-srcset",selector:".lazyload",root:null,rootMargin:"0px",threshold:0},r=function(){let t={},e=!1,s=0,o=arguments.length;"[object Boolean]"===Object.prototype.toString.call(arguments[0])&&(e=arguments[0],s++);let i=function(s){for(let o in s)Object.prototype.hasOwnProperty.call(s,o)&&(e&&"[object Object]"===Object.prototype.toString.call(s[o])?t[o]=r(!0,t[o],s[o]):t[o]=s[o])};for(;s<o;s++){i(arguments[s])}return t};function s(t,s){this.settings=r(e,s||{}),this.images=t||document.querySelectorAll(this.settings.selector),this.observer=null,this.init()}if(s.prototype={init:function(){if(!t.IntersectionObserver)return void this.loadImages();let e=this,r={root:this.settings.root,rootMargin:this.settings.rootMargin,threshold:[this.settings.threshold]};this.observer=new IntersectionObserver(function(t){Array.prototype.forEach.call(t,function(t){if(t.isIntersecting){e.observer.unobserve(t.target);let r=t.target.getAttribute(e.settings.src),s=t.target.getAttribute(e.settings.srcset);"img"===t.target.tagName.toLowerCase()?(r&&(t.target.src=r),s&&(t.target.srcset=s)):t.target.style.backgroundImage="url("+r+")"}})},r),Array.prototype.forEach.call(this.images,function(t){e.observer.observe(t)})},loadAndDestroy:function(){this.settings&&(this.loadImages(),this.destroy())},loadImages:function(){if(!this.settings)return;let t=this;Array.prototype.forEach.call(this.images,function(e){let r=e.getAttribute(t.settings.src),s=e.getAttribute(t.settings.srcset);"img"===e.tagName.toLowerCase()?(r&&(e.src=r),s&&(e.srcset=s)):e.style.backgroundImage="url('"+r+"')"})},destroy:function(){this.settings&&(this.observer.disconnect(),this.settings=null)}},t.lazyload=function(t,e){return new s(t,e)},t.jQuery){const e=t.jQuery;e.fn.lazyload=function(t){return(t=t||{}).attribute=t.attribute||"data-src",new s(e.makeArray(this),t),this}}return s});let images=document.querySelectorAll("img");lazyload(images);
$(function(){var t=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),e=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),n=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");function s(t,e,n,s){var a="rgb("+t+","+e+","+n+")",r="#"+s,i="#fff",o=parseInt(t),l=parseInt(e),c=parseInt(n),d=Math.sqrt(o*o*.299+l*l*.587+c*c*.114);d>127.5&&(i="#000"),NaN!=d&&($("#rgb-sample").text(a).css("color",i),$("#hex-sample").text(r).css("color",i))}function a(t){var e=t.toString(16);return 1==e.length?"0"+e:e}function r(t){$(".color-sample").css("background-color","#"+t)}function i(){var t=$("#select-aspect-ratio").children("option:selected").val(),e=$("#custom-aspect-ratio").val();return""!=t?t:e.replace(":","*").replace(/ /g,"")}t.click(function(){var t=$(this).siblings("ul.sub-menu");return t.is(":visible")||e.hide(),t.slideToggle("500"),!1}),n.click(function(){var t=$(this).attr("href");window.location=t}),$(window).scroll(function(){e.is(":visible")&&$(e).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var t="";t="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var e={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:t,type:"post",data:e,success:function(t){t=JSON.parse(t),$("#output-resource").val(t.minified_resource),$("#minify-description").html("Original Size: "+t.original_size/1e3+"KB<br>Minified Size: "+t.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var t,e,n,i=$("#color-rgb-red").val(),o=$("#color-rgb-green").val(),l=$("#color-rgb-blue").val(),c="";""!=i&&""!=o&&""!=l&&(t=parseInt(i),e=parseInt(o),n=parseInt(l),c=a(t)+a(e)+a(n),$("#color-hex").val(c)),r(c),s(i,o,l,c)}),$("#color-hex").keyup(function(){var t=$("#color-hex").val();if(""!=t){var e=function(t){t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(t,e,n,s){return e+e+n+n+s+s});var e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null}(t);$("#color-rgb-red").val(e.r),$("#color-rgb-green").val(e.g),$("#color-rgb-blue").val(e.b)}r(t),s(e.r,e.g,e.b,t)}),$("#dimension-w, #dimension-h").keyup(function(){var t=$("#dimension-w").val(),e=$("#dimension-h").val();if(""!=t&&""!=e){var n=function(t,e){return function t(e,n){return 0==n?e:t(n,e%n)}(t,e)}(parseInt(t),parseInt(e));$("#calculated-aspect-ratio").text(parseInt(t)/n+":"+parseInt(e)/n)}}),$("#dimension-w1").keyup(function(){var t=$("#dimension-w1").val(),e=i();if(""!=e){var n=e.split("*")[0],s=e.split("*")[1];$("#dimension-h1").val(parseInt(t)*parseInt(s)/parseInt(n))}}),$("#dimension-h1").keyup(function(){var t=$("#dimension-h1").val(),e=i();if(""!=e){var n=e.split("*")[0],s=e.split("*")[1];$("#dimension-w1").val(parseInt(t)*parseInt(n)/parseInt(s))}}),$("#dimension-w2").keyup(function(){var t=parseInt($("#dimension-w2").val()),e=parseInt($("#dimension-w1").val()),n=parseInt($("#dimension-h1").val());$("#dimension-h2").val(t*n/e)}),$("#dimension-h2").keyup(function(){var t=parseInt($("#dimension-h2").val()),e=parseInt($("#dimension-w1").val()),n=parseInt($("#dimension-h1").val());$("#dimension-w2").val(t*e/n)}),$("#shortlink-list").click(function(){$("#shortlink-list-view").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-shortlinks/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(t){var e="";if("success"==t.status){var n="",s=t.message;$.each(s,function(t,e){var s=siteUrl+"/"+e.shortLink;n+='<p><a href="'+s+'" target="_blank">'+s+"</a> - "+e.redirectLink+"</p>"}),$("#shortlink-list-view").html(n)}else e='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';$("#message-container").html(e)})}),$("#add-shortlink-form").submit(function(t){t.preventDefault();var e=$(this).serialize();$.ajax({url:wpApiSettings.root+"dshortlink/v1/add-shortlink/?_wpnonce="+wpApiSettings.nonce,data:e,type:"post"}).done(function(t){var e="";e="success"==t.status?'<div class="alert alert-success alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Success!!</strong> Shortlink created</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>':'<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>',$("#message-container").html(e)})});var o=["#5e72e4","#8965e0","#f5365c","#ffd600","#fb6340","#2dce89","#f3a4b5","#11cdef","#5603ad","#2bffc6"];$("#shortlink-dashboard").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-stats/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(t){var e="";if("success"==t.status){var n=t.message.totalClicks[0].clicks,s=t.message.todayClicks[0].clicks,a=t.message.byClicks,r=t.message.byReferer,i=t.message.byCountry;!function(t){var e=document.getElementById("shortlink-stats-total-clicks-chart").getContext("2d");new Chart(e,{type:"doughnut",data:{datasets:[{data:[t],backgroundColor:["#5e72e4"],label:"Total Clicks"}],labels:["Total Clicks"]},options:{responsive:!0,elements:{center:{text:t,color:"#5e72e4",fontStyle:"Arial",sidePadding:40}}}});$("#shortlink-stats-total-clicks-number").text(t)}(n),function(t){var e=document.getElementById("shortlink-stats-today-clicks-chart").getContext("2d");new Chart(e,{type:"doughnut",data:{datasets:[{data:[t],backgroundColor:["#5e72e4"],label:"Today Clicks"}],labels:["Today Clicks"]},options:{responsive:!0,elements:{center:{text:t,color:"#5e72e4",fontStyle:"Arial",sidePadding:40}}}});$("#shortlink-stats-today-clicks-number").text(t)}(s),function(t){var e=[],n=[],s=[],a="";$.each(t,function(t,r){e.push(r.clicks),n.push(r.shortLink),s.push(o[t%10]),a+="<tr><td>"+(t+1)+"</td><td>"+r.shortLink+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-clicks-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:s}],labels:n},options:{responsive:!0}});$("#shortlink-stats-by-clicks-table tbody").html(a)}(a),function(t){var e=[],n=[],s=[],a="";$.each(t,function(t,r){e.push(r.clicks),n.push(r.referer),s.push(o[t%10]),a+="<tr><td>"+(t+1)+"</td><td>"+r.referer+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-referer-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:s}],labels:n},options:{responsive:!0}});$("#shortlink-stats-by-referer-table tbody").html(a)}(r),function(t){var e=[],n=[],s=[],a="";$.each(t,function(t,r){e.push(r.clicks),n.push(r.country),s.push(o[t%10]),a+="<tr><td>"+(t+1)+"</td><td>"+r.country+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-country-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:s}],labels:n},options:{responsive:!0}});$("#shortlink-stats-by-country-table tbody").html(a)}(i)}else e='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';$("#message-container").html(e)})});