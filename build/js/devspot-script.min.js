...
$(function(){var e=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),i=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu");e.click(function(){var e=$(this).siblings("ul.sub-menu");return e.is(":visible")||i.hide(),e.slideToggle("500"),!1}),$(window).scroll(function(){i.is(":visible")&&$(i).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var e="";e="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var i={unminified_resource:$("#input-resource").val()};$.ajax({url:e,type:"post",data:i,success:function(e){e=JSON.parse(e),$("#output-resource").val(e.minified_resource)}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")})});