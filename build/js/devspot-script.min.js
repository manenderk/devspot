...
$(function(){var n=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),e=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),i=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");function a(n,e,i,r){var a="rgb("+n+","+e+","+i+")",t="#"+r,o="#fff",s=parseInt(n),l=parseInt(e),c=parseInt(i),u=Math.sqrt(s*s*.299+l*l*.587+c*c*.114);127.5<u&&(o="#000"),NaN!=u&&($("#rgb-sample").text(a).css("color",o),$("#hex-sample").text(t).css("color",o))}function t(n){var e=n.toString(16);return 1==e.length?"0"+e:e}function o(n){$(".color-sample").css("background-color","#"+n)}function s(){var n=$("#select-aspect-ratio").children("option:selected").val(),e=$("#custom-aspect-ratio").val();return""!=n?n:e.replace(":","*").replace(/ /g,"")}n.click(function(){var n=$(this).siblings("ul.sub-menu");return n.is(":visible")||e.hide(),n.slideToggle("500"),!1}),i.click(function(){var n=$(this).attr("href");window.location=n}),$(window).scroll(function(){e.is(":visible")&&$(e).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var n="";n="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var e={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:n,type:"post",data:e,success:function(n){n=JSON.parse(n),$("#output-resource").val(n.minified_resource),$("#minify-description").html("Original Size: "+n.original_size/1e3+"KB<br>Minified Size: "+n.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var n=$("#color-rgb-red").val(),e=$("#color-rgb-green").val(),i=$("#color-rgb-blue").val(),r="";""!=n&&""!=e&&""!=i&&(r=function(n,e,i){return t(n)+t(e)+t(i)}(parseInt(n),parseInt(e),parseInt(i)),$("#color-hex").val(r)),o(r),a(n,e,i,r)}),$("#color-hex").keyup(function(){var n=$("#color-hex").val();if(""!=n){var e=function(n){n=n.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(n,e,i,r){return e+e+i+i+r+r});var e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(n);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null}(n);$("#color-rgb-red").val(e.r),$("#color-rgb-green").val(e.g),$("#color-rgb-blue").val(e.b)}o(n),a(e.r,e.g,e.b,n)}),$("#dimension-w, #dimension-h").keyup(function(){var n=$("#dimension-w").val(),e=$("#dimension-h").val();if(""!=n&&""!=e){var i=function(n,e){return function n(e,i){return 0==i?e:n(i,e%i)}(n,e)}(parseInt(n),parseInt(e));$("#calculated-aspect-ratio").text(parseInt(n)/i+":"+parseInt(e)/i)}}),$("#dimension-w1").keyup(function(){var n=$("#dimension-w1").val(),e=s();if(""!=e){var i=e.split("*")[0],r=e.split("*")[1];$("#dimension-h1").val(parseInt(n)*parseInt(r)/parseInt(i))}}),$("#dimension-h1").keyup(function(){var n=$("#dimension-h1").val(),e=s();if(""!=e){var i=e.split("*")[0],r=e.split("*")[1];$("#dimension-w1").val(parseInt(n)*parseInt(i)/parseInt(r))}}),$("#dimension-w2").keyup(function(){var n=parseInt($("#dimension-w2").val()),e=parseInt($("#dimension-w1").val()),i=parseInt($("#dimension-h1").val());$("#dimension-h2").val(n*i/e)}),$("#dimension-h2").keyup(function(){var n=parseInt($("#dimension-h2").val()),e=parseInt($("#dimension-w1").val()),i=parseInt($("#dimension-h1").val());$("#dimension-w2").val(n*e/i)})});