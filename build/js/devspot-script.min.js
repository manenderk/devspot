...
$(function(){var e=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),r=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu");function o(e){var r=e.toString(16);return 1==r.length?"0"+r:r}function a(e){$(".color-sample").css("background-color","#"+e)}e.click(function(){var e=$(this).siblings("ul.sub-menu");return e.is(":visible")||r.hide(),e.slideToggle("500"),!1}),$(window).scroll(function(){r.is(":visible")&&$(r).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var e="";e="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var r={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:e,type:"post",data:r,success:function(e){e=JSON.parse(e),$("#output-resource").val(e.minified_resource),$("#minify-description").html("Original Size: "+e.original_size/1e3+"KB<br>Minified Size: "+e.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var e=$("#color-rgb-red").val(),r=$("#color-rgb-green").val(),n=$("#color-rgb-blue").val(),i="";""!=e&&""!=r&&""!=n&&(i=function(e,r,n){return o(e)+o(r)+o(n)}(parseInt(e),parseInt(r),parseInt(n)),$("#color-hex").val(i)),a(i)}),$("#color-hex").keyup(function(){var e=$("#color-hex").val();if(""!=e){var r=function(e){e=e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(e,r,n,i){return r+r+n+n+i+i});var r=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return r?{r:parseInt(r[1],16),g:parseInt(r[2],16),b:parseInt(r[3],16)}:null}(e);$("#color-rgb-red").val(r.r),$("#color-rgb-green").val(r.g),$("#color-rgb-blue").val(r.b)}a(e)}),$("#dimension-w, #dimension-h").keyup(function(){var e=$("#dimension-w").val(),r=$("#dimension-h").val();if(""!=e&&""!=r){var n=function(e,r){return function e(r,n){return 0==n?r:e(n,r%n)}(e,r)}(parseInt(e),parseInt(r));$("#calculated-aspect-ratio").text(parseInt(e)/n+":"+parseInt(r)/n)}})});