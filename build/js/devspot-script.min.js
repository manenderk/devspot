...
$(function(){var e=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),n=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),i=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");e.click(function(){var e=$(this).siblings("ul.sub-menu");return e.is(":visible")||n.hide(),e.slideToggle("500"),!1}),i.click(function(){var e=$(this).attr("href");window.location=e}),$(window).scroll(function(){n.is(":visible")&&$(n).hide()}),$("#copyright-year").text((new Date).getFullYear());let r=document.querySelectorAll("img");function a(e,n,i,r){var a="rgb("+e+","+n+","+i+")",t="#"+r,o="#fff",s=parseInt(e),l=parseInt(n),c=parseInt(i),u=Math.sqrt(s*s*.299+l*l*.587+c*c*.114);u>127.5&&(o="#000"),NaN!=u&&($("#rgb-sample").text(a).css("color",o),$("#hex-sample").text(t).css("color",o))}function t(e){var n=e.toString(16);return 1==n.length?"0"+n:n}function o(e){$(".color-sample").css("background-color","#"+e)}function s(){var e=$("#select-aspect-ratio").children("option:selected").val(),n=$("#custom-aspect-ratio").val();return""!=e?e:n.replace(":","*").replace(/ /g,"")}lazyload(r),$("#minify-resource").click(function(){var e="";e="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var n={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:e,type:"post",data:n,success:function(e){e=JSON.parse(e),$("#output-resource").val(e.minified_resource),$("#minify-description").html("Original Size: "+e.original_size/1e3+"KB<br>Minified Size: "+e.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var e,n,i,r=$("#color-rgb-red").val(),s=$("#color-rgb-green").val(),l=$("#color-rgb-blue").val(),c="";""!=r&&""!=s&&""!=l&&(e=parseInt(r),n=parseInt(s),i=parseInt(l),c=t(e)+t(n)+t(i),$("#color-hex").val(c)),o(c),a(r,s,l,c)}),$("#color-hex").keyup(function(){var e=$("#color-hex").val();if(""!=e){var n=function(e){e=e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(e,n,i,r){return n+n+i+i+r+r});var n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return n?{r:parseInt(n[1],16),g:parseInt(n[2],16),b:parseInt(n[3],16)}:null}(e);$("#color-rgb-red").val(n.r),$("#color-rgb-green").val(n.g),$("#color-rgb-blue").val(n.b)}o(e),a(n.r,n.g,n.b,e)}),$("#dimension-w, #dimension-h").keyup(function(){var e=$("#dimension-w").val(),n=$("#dimension-h").val();if(""!=e&&""!=n){var i=function(e,n){return function e(n,i){return 0==i?n:e(i,n%i)}(e,n)}(parseInt(e),parseInt(n));$("#calculated-aspect-ratio").text(parseInt(e)/i+":"+parseInt(n)/i)}}),$("#dimension-w1").keyup(function(){var e=$("#dimension-w1").val(),n=s();if(""!=n){var i=n.split("*")[0],r=n.split("*")[1];$("#dimension-h1").val(parseInt(e)*parseInt(r)/parseInt(i))}}),$("#dimension-h1").keyup(function(){var e=$("#dimension-h1").val(),n=s();if(""!=n){var i=n.split("*")[0],r=n.split("*")[1];$("#dimension-w1").val(parseInt(e)*parseInt(i)/parseInt(r))}}),$("#dimension-w2").keyup(function(){var e=parseInt($("#dimension-w2").val()),n=parseInt($("#dimension-w1").val()),i=parseInt($("#dimension-h1").val());$("#dimension-h2").val(e*i/n)}),$("#dimension-h2").keyup(function(){var e=parseInt($("#dimension-h2").val()),n=parseInt($("#dimension-w1").val()),i=parseInt($("#dimension-h1").val());$("#dimension-w2").val(e*n/i)})});