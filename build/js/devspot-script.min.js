...
$(function(){var e=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),n=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),t=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");function s(e,n,t,s){var a="rgb("+e+","+n+","+t+")",i="#"+s,r="#fff",l=parseInt(e),o=parseInt(n),c=parseInt(t),u=Math.sqrt(l*l*.299+o*o*.587+c*c*.114);u>127.5&&(r="#000"),NaN!=u&&($("#rgb-sample").text(a).css("color",r),$("#hex-sample").text(i).css("color",r))}function a(e){var n=e.toString(16);return 1==n.length?"0"+n:n}function i(e){$(".color-sample").css("background-color","#"+e)}function r(){var e=$("#select-aspect-ratio").children("option:selected").val(),n=$("#custom-aspect-ratio").val();return""!=e?e:n.replace(":","*").replace(/ /g,"")}e.click(function(){var e=$(this).siblings("ul.sub-menu");return e.is(":visible")||n.hide(),e.slideToggle("500"),!1}),t.click(function(){var e=$(this).attr("href");window.location=e}),$(window).scroll(function(){n.is(":visible")&&$(n).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var e="";e="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var n={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:e,type:"post",data:n,success:function(e){e=JSON.parse(e),$("#output-resource").val(e.minified_resource),$("#minify-description").html("Original Size: "+e.original_size/1e3+"KB<br>Minified Size: "+e.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var e,n,t,r=$("#color-rgb-red").val(),l=$("#color-rgb-green").val(),o=$("#color-rgb-blue").val(),c="";""!=r&&""!=l&&""!=o&&(e=parseInt(r),n=parseInt(l),t=parseInt(o),c=a(e)+a(n)+a(t),$("#color-hex").val(c)),i(c),s(r,l,o,c)}),$("#color-hex").keyup(function(){var e=$("#color-hex").val();if(""!=e){var n=function(e){e=e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(e,n,t,s){return n+n+t+t+s+s});var n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return n?{r:parseInt(n[1],16),g:parseInt(n[2],16),b:parseInt(n[3],16)}:null}(e);$("#color-rgb-red").val(n.r),$("#color-rgb-green").val(n.g),$("#color-rgb-blue").val(n.b)}i(e),s(n.r,n.g,n.b,e)}),$("#dimension-w, #dimension-h").keyup(function(){var e=$("#dimension-w").val(),n=$("#dimension-h").val();if(""!=e&&""!=n){var t=function(e,n){return function e(n,t){return 0==t?n:e(t,n%t)}(e,n)}(parseInt(e),parseInt(n));$("#calculated-aspect-ratio").text(parseInt(e)/t+":"+parseInt(n)/t)}}),$("#dimension-w1").keyup(function(){var e=$("#dimension-w1").val(),n=r();if(""!=n){var t=n.split("*")[0],s=n.split("*")[1];$("#dimension-h1").val(parseInt(e)*parseInt(s)/parseInt(t))}}),$("#dimension-h1").keyup(function(){var e=$("#dimension-h1").val(),n=r();if(""!=n){var t=n.split("*")[0],s=n.split("*")[1];$("#dimension-w1").val(parseInt(e)*parseInt(t)/parseInt(s))}}),$("#dimension-w2").keyup(function(){var e=parseInt($("#dimension-w2").val()),n=parseInt($("#dimension-w1").val()),t=parseInt($("#dimension-h1").val());$("#dimension-h2").val(e*t/n)}),$("#dimension-h2").keyup(function(){var e=parseInt($("#dimension-h2").val()),n=parseInt($("#dimension-w1").val()),t=parseInt($("#dimension-h1").val());$("#dimension-w2").val(e*n/t)}),$("#shortlink-list").click(function(){$("#shortlink-list-view").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-shortlinks/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(e){var n="";if("success"==e.status){var t="",s=e.message;$.each(s,function(e,n){var s=siteUrl+"/"+n.shortLink;t+='<p><a href="'+s+'">'+s+"</a> - "+n.redirectLink+"</p>"}),$("#shortlink-list-view").html(t)}else n='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+e.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';$("#message-container").html(n)})}),$("#add-shortlink-form").submit(function(e){e.preventDefault();var n=$(this).serialize();$.ajax({url:wpApiSettings.root+"dshortlink/v1/add-shortlink/?_wpnonce="+wpApiSettings.nonce,data:n,type:"post"}).done(function(e){var n="";n="success"==e.status?'<div class="alert alert-success alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Success!!</strong> Shortlink created</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>':'<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+e.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>',$("#message-container").html(n)})}),$("#shortlink-dashboard").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-stats/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(e){var n="";"success"==e.status?console.log(e.message):n='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+e.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>',$("#message-container").html(n)})});