...
!function(t){if(!t.isInit){var e={getCookie:function(t){var e=("; "+document.cookie).split("; "+t+"=");return e.length<2?void 0:e.pop().split(";").shift()},setCookie:function(t,e,n,i,s,o){if(""!=t){var r=new Date;r.setDate(r.getDate()+(n||365));var a=[t+"="+e,"expires="+r.toUTCString(),"path="+(s||"/")];i&&a.push("domain="+i),o&&a.push("secure"),document.cookie=a.join(";")}},compileTemplate:function(t,e){return t.replace(/{{([a-z][a-z0-9\-_]*)}}/gi,function(t){return e(arguments[1])||""})},addClass:function(t,e){t.className+=" "+e},removeClass:function(t,e){var n=new RegExp("\\b"+e+"\\b");t.className=t.className.replace(n,"")},hasClass:function(t,e){return 1===t.nodeType&&(" "+t.className+" ").replace(/[\n\t]/g," ").indexOf(" "+e+" ")>=0},extend:function(t,e){for(var n in e)e.hasOwnProperty(n)&&(n in t&&this.isPlainObj(t[n])&&this.isPlainObj(e[n])?this.extend(t[n],e[n]):t[n]=e[n]);return t},isPlainObj:function(t){return"object"==typeof t&&null!==t&&t.constructor==Object},normalizeColor:function(t){return"#"==t[0]&&(t=t.substr(1)),3==t.length&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),t},hashColors:function(t){var e,n,i=0;if(0===t.length)return i;for(e=0,n=t.length;e<n;++e)i=(i<<5)-i+t.charCodeAt(e),i|=0;return i},getLuminance:function(t){var e=parseInt(this.normalizeColor(t),16),n=(e>>16)-20,i=(e>>8&255)-20,s=(255&e)-20;return"#"+(16777216+65536*(n<255?n<1?0:n:255)+256*(i<255?i<1?0:i:255)+(s<255?s<1?0:s:255)).toString(16).slice(1)},isMobile:function(){return/Android|webOS|iPhone|iPad|iPod|IEMobile|Opera Mini|BlackBerry/i.test(navigator.userAgent)}};t.fadeEnd=function(){var t=document.createElement("div"),e={t:"transitionend",MozT:"transitionend",msT:"MSTransitionEnd",OT:"oTransitionEnd",WebkitT:"webkitTransitionEnd"};for(var n in e)if(e.hasOwnProperty(n)&&void 0!==t.style[n+"ransition"])return e[n];return""}(),t.fading=!!t.fadeEnd,t.customCSS={},t.Popup=function(){var n={enabled:!0,autoOpen:!0,cookie:{name:"wpcc",path:"/",domain:"",expiryDays:365,secure:!1},content:{message:"This website uses cookies to ensure you get the best experience on our website.",link:"Learn more",href:"https://www.internetcookies.org",target:"_blank",button:"Got it!"},container:'<div class="wpcc-container {{classes}}">{{children}}</div>',template:'<span class="wpcc-message">{{message}} <a class="wpcc-privacy" href="{{href}}" rel="noopener" target="{{target}}" tabindex="1">{{link}}</a></span><div class="wpcc-compliance"><a class="wpcc-btn" tabindex="2">{{button}}</a></div>',pushdown:!1,position:"bottom-left",corners:"",padding:"",margin:"",fontsize:"",transparency:"",border:"",colors:null,onInit:function(t){},onStatusChange:function(t,e){}};function i(){this.init.apply(this,arguments)}function s(t){this.displayTimeout=null,e.removeClass(t,"wpcc-invisible")}function o(e){e.style.display="none",e.removeEventListener(t.fadeEnd,this.afterFading),this.afterFading=null}function r(n){var i=this.options,s=document.createElement("div"),o=i.container&&1===i.container.nodeType?i.container:document.body;s.innerHTML=n;var r=s.children[0];r.style.display="none",e.hasClass(r,"wpcc-container")&&t.fading&&e.addClass(r,"wpcc-invisible"),this.onButtonClick=function(t){this.setStatus("dismiss"),this.close()}.bind(this),this.onButtonEnter=function(t){13===t.keyCode&&(t.preventDefault(),this.setStatus("dismiss"),this.close())}.bind(this);var a=r.getElementsByClassName("wpcc-btn")[0];return a.addEventListener("click",this.onButtonClick),a.addEventListener("keyup",this.onButtonEnter),o.firstChild?o.insertBefore(r,o.firstChild):o.appendChild(r),r}function a(t){return"000000"==(t=e.normalizeColor(t))?"#222222":e.getLuminance(t)}return i.prototype.init=function(i){this.options&&this.destroy(),e.extend(this.options={},n),e.isPlainObj(i)&&e.extend(this.options,i),function(){var t=this.options.onInit.bind(this);if(window.CookiesOK||window.navigator.CookiesOK)return t("dismiss"),!0;var e=this.getStatus(),n="dismiss"==e;return n&&t(e),n}.call(this)&&(this.options.enabled=!1);var s=this.options.container.replace("{{classes}}",function(){var n=this.options,i="top"==n.position||"bottom"==n.position?"banner":"float";e.isMobile()&&(i="float");var s=["wpcc-"+i];return n.corners&&s.push("wpcc-corners-round wpcc-corners-"+n.corners),n.padding&&s.push("wpcc-padding-"+n.padding),n.margin&&s.push("wpcc-margin-"+n.margin),n.transparency&&s.push("wpcc-transparency-"+n.transparency),n.fontsize&&s.push("wpcc-fontsize-"+n.fontsize),n.border&&s.push("wpcc-border-"+n.border),n.pushdown&&s.push("wpcc-pushdown"),s.push.apply(s,function(){var t=this.options.position.split("-"),e=[];return t.forEach(function(t){e.push("wpcc-"+t)}),e}.call(this)),function(n){var i=e.hashColors(JSON.stringify(n)),s="wpcc-color-custom-"+i,o=e.isPlainObj(n);return this.customCSS=o?s:null,o&&function(e,n,i){if(t.customCSS[e])++t.customCSS[e].references;else{var s={},o=n.popup,r=n.button;o&&(s[i+".wpcc-container"]=["background-color: "+o.background,"border-color: "+o.border,"color: "+o.text],s[i+" .wpcc-privacy,"+i+" .wpcc-privacy:active,"+i+" .wpcc-privacy:visited"]=["color: "+o.text],r&&(s[i+" .wpcc-btn"]=["color: "+r.text,"background-color: "+r.background],s[i+" .wpcc-btn:focus, "+i+" .wpcc-btn:hover"]=["background-color: "+a(r.background)]));var c=document.createElement("style");document.head.appendChild(c),t.customCSS[e]={references:1,element:c.sheet};var p=-1;for(var l in s)s.hasOwnProperty(l)&&c.sheet.insertRule(l+"{"+s[l].join(";")+"}",++p)}}(i,n,"."+s),o}.call(this,this.options.colors),this.customCSS&&s.push(this.customCSS),s}.call(this).join(" ")).replace("{{children}}",function(){var t=this.options;return e.compileTemplate(t.template,function(e){var n=t.content[e];return e&&"string"==typeof n&&n.length?n:""})}.call(this));this.options.pushdown?(this.wrapper=r.call(this,'<div class="wpcc-pushdown-wrap">'+s+"</div>"),this.wrapper.style.display="",this.element=this.wrapper.firstChild,this.element.style.display="none",e.addClass(this.element,"wpcc-invisible")):(this.wrapper=null,this.element=r.call(this,s)),this.options.autoOpen&&this.autoOpen()},i.prototype.destroy=function(){this.onButtonClick&&this.element&&(this.element.removeEventListener("click",this.onButtonClick),this.onButtonClick=null),this.onButtonEnter&&this.element&&(this.element.removeEventListener("keyup",this.onButtonEnter),this.onButtonEnter=null),this.wrapper&&this.wrapper.parentNode?this.wrapper.parentNode.removeChild(this.wrapper):this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element),this.wrapper=null,this.element=null,function(n){if(e.isPlainObj(n)){var i=e.hashColors(JSON.stringify(n)),s=t.customCSS[i];if(s&&!--s.references){var o=s.element.ownerNode;o&&o.parentNode&&o.parentNode.removeChild(o),t.customCSS[i]=null}}}(this.options.colors),this.options=null},i.prototype.open=function(e){if(this.element)return this.isOpen()||(t.fading?this.fadeIn():this.element.style.display=""),this},i.prototype.close=function(){if(this.element)return this.isOpen()&&(t.fading?this.fadeOut():this.element.style.display="none"),this},i.prototype.fadeIn=function(){var n=this.element;if(t.fading&&n&&(this.afterFading&&o.call(this,n),e.hasClass(n,"wpcc-invisible"))){if(n.style.display="",this.options.pushdown){var i=0,r=this.element.clientHeight;e.hasClass(this.element,"wpcc-border-1")?i=1:e.hasClass(this.element,"wpcc-border-2")?i=2:e.hasClass(this.element,"wpcc-border-3")?i=3:e.hasClass(this.element,"wpcc-border-4")?i=4:e.hasClass(this.element,"wpcc-border-5")&&(i=5),this.element.parentNode.style.maxHeight=r+2*i+"px"}this.displayTimeout=setTimeout(s.bind(this,n),25)}},i.prototype.fadeOut=function(){var n=this.element;n&&t.fading&&(this.displayTimeout&&(clearTimeout(this.displayTimeout),s.bind(this,n)),e.hasClass(n,"wpcc-invisible")||(this.options.pushdown&&(this.element.parentNode.style.maxHeight=""),this.afterFading=o.bind(this,n),n.addEventListener(t.fadeEnd,this.afterFading),e.addClass(n,"wpcc-invisible")))},i.prototype.isOpen=function(){return this.element&&""==this.element.style.display&&(!t.fading||!e.hasClass(this.element,"wpcc-invisible"))},i.prototype.savedCookie=function(t){return"dismiss"==this.getStatus()},i.prototype.autoOpen=function(t){!this.savedCookie()&&this.options.enabled&&this.open()},i.prototype.setStatus=function(t){var n=this.options.cookie,i=e.getCookie(n.name);e.setCookie(n.name,t,n.expiryDays,n.domain,n.path,n.secure),this.options.onStatusChange.call(this,t,"dismiss"==i)},i.prototype.getStatus=function(){return e.getCookie(this.options.cookie.name)},i.prototype.clearStatus=function(){var t=this.options.cookie;e.setCookie(t.name,"",-1,t.domain,t.path,t.secure)},i}(),t.init=function(e,n,i){n||(n=function(){}),i||(i=function(){}),n(new t.Popup(e))},t.isInit=!0,window.wpcc=t}}(window.wpcc||{});
window.addEventListener("load",function(){window.wpcc.init({border:"thin",corners:"small",colors:{popup:{background:"#f0edff",text:"#000000",border:"#5e65c2"},button:{background:"#5e65c2",text:"#ffffff"}},fontsize:"small",content:{href:"https://www.deevsi.com/privacy-policy/"}})}),$(function(){var t=$("ul.navbar-nav li.menu-item-has-children.nav-item a.nav-link"),e=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu"),s=$("ul.navbar-nav li.menu-item-has-children.nav-item ul.sub-menu li.menu-item a.nav-link");function n(t,e,s,n){var a="rgb("+t+","+e+","+s+")",r="#"+n,o="#fff",i=parseInt(t),l=parseInt(e),c=parseInt(s),d=Math.sqrt(i*i*.299+l*l*.587+c*c*.114);d>127.5&&(o="#000"),NaN!=d&&($("#rgb-sample").text(a).css("color",o),$("#hex-sample").text(r).css("color",o))}function a(t){var e=t.toString(16);return 1==e.length?"0"+e:e}function r(t){$(".color-sample").css("background-color","#"+t)}function o(){var t=$("#select-aspect-ratio").children("option:selected").val(),e=$("#custom-aspect-ratio").val();return""!=t?t:e.replace(":","*").replace(/ /g,"")}t.click(function(){var t=$(this).siblings("ul.sub-menu");return t.is(":visible")||e.hide(),t.slideToggle("500"),!1}),s.click(function(){var t=$(this).attr("href");window.location=t}),$(window).scroll(function(){e.is(":visible")&&$(e).hide()}),$("#copyright-year").text((new Date).getFullYear()),$("#minify-resource").click(function(){var t="";t="css"==$("input[name='input-resource-type']:checked").val()?siteUrl+"/api/minify/css":siteUrl+"/api/minify/js";var e={unminified_resource:$("#input-resource").val().toString()};$.ajax({url:t,type:"post",data:e,success:function(t){t=JSON.parse(t),$("#output-resource").val(t.minified_resource),$("#minify-description").html("Original Size: "+t.original_size/1e3+"KB<br>Minified Size: "+t.minified_size/1e3+"KB"),$("#minify-description").show()}})}),$("#copy-minified-resource").click(function(){$("#output-resource").select(),document.execCommand("copy")}),$("#color-rgb-red, #color-rgb-green, #color-rgb-blue").keyup(function(){var t,e,s,o=$("#color-rgb-red").val(),i=$("#color-rgb-green").val(),l=$("#color-rgb-blue").val(),c="";""!=o&&""!=i&&""!=l&&(t=parseInt(o),e=parseInt(i),s=parseInt(l),c=a(t)+a(e)+a(s),$("#color-hex").val(c)),r(c),n(o,i,l,c)}),$("#color-hex").keyup(function(){var t=$("#color-hex").val();if(""!=t){var e=function(t){t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(t,e,s,n){return e+e+s+s+n+n});var e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null}(t);$("#color-rgb-red").val(e.r),$("#color-rgb-green").val(e.g),$("#color-rgb-blue").val(e.b)}r(t),n(e.r,e.g,e.b,t)}),$("#dimension-w, #dimension-h").keyup(function(){var t=$("#dimension-w").val(),e=$("#dimension-h").val();if(""!=t&&""!=e){var s=function(t,e){return function t(e,s){return 0==s?e:t(s,e%s)}(t,e)}(parseInt(t),parseInt(e));$("#calculated-aspect-ratio").text(parseInt(t)/s+":"+parseInt(e)/s)}}),$("#dimension-w1").keyup(function(){var t=$("#dimension-w1").val(),e=o();if(""!=e){var s=e.split("*")[0],n=e.split("*")[1];$("#dimension-h1").val(parseInt(t)*parseInt(n)/parseInt(s))}}),$("#dimension-h1").keyup(function(){var t=$("#dimension-h1").val(),e=o();if(""!=e){var s=e.split("*")[0],n=e.split("*")[1];$("#dimension-w1").val(parseInt(t)*parseInt(s)/parseInt(n))}}),$("#dimension-w2").keyup(function(){var t=parseInt($("#dimension-w2").val()),e=parseInt($("#dimension-w1").val()),s=parseInt($("#dimension-h1").val());$("#dimension-h2").val(t*s/e)}),$("#dimension-h2").keyup(function(){var t=parseInt($("#dimension-h2").val()),e=parseInt($("#dimension-w1").val()),s=parseInt($("#dimension-h1").val());$("#dimension-w2").val(t*e/s)}),$("#shortlink-list").click(function(){$("#shortlink-list-view").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-shortlinks/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(t){var e="";if("success"==t.status){var s='<table class="table">',n=t.message;$.each(n,function(t,e){var n=siteUrl+"/"+e.shortLink;s+='<tr><td><a href="'+n+'" target="_blank">'+n+"</a> - "+e.redirectLink+'</td><td class="text-right"><button class="btn btn-sm btn-primary shortlink-delete-action" shortlink-id="'+e.id+'" ><i class="fa fa-trash"></i></button></td></td></tr>'}),s+="</table>",$("#shortlink-list-view").html(s)}else e='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';$("#message-container").html(e)})}),$(document).on("click",".shortlink-delete-action",function(){var t={shortlinkId:$(this).attr("shortlink-id")};$.ajax({url:wpApiSettings.root+"dshortlink/v1/delete-shortlink/?_wpnonce="+wpApiSettings.nonce,data:t,type:"post"}).done(function(t){var e="";e="success"==t.status?'<div class="alert alert-success alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Success!!</strong> Shortlink deleted</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>':'<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>',$("#shortlink-list").trigger("click"),$("#message-container").html(e)})}),$("#add-shortlink-form").submit(function(t){t.preventDefault();var e=$(this).serialize();$.ajax({url:wpApiSettings.root+"dshortlink/v1/add-shortlink/?_wpnonce="+wpApiSettings.nonce,data:e,type:"post"}).done(function(t){var e="";e="success"==t.status?'<div class="alert alert-success alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Success!!</strong> Shortlink created</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>':'<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>',$("#message-container").html(e)})});var i=["#5e72e4","#8965e0","#f5365c","#ffd600","#fb6340","#2dce89","#f3a4b5","#11cdef","#5603ad","#2bffc6"];$("#shortlink-dashboard").length&&$.ajax({url:wpApiSettings.root+"dshortlink/v1/get-stats/?_wpnonce="+wpApiSettings.nonce,type:"get"}).done(function(t){var e="";if("success"==t.status){var s=t.message.totalClicks[0].clicks,n=t.message.todayClicks[0].clicks,a=t.message.byClicks,r=t.message.byReferer,o=t.message.byCountry;!function(t){var e=document.getElementById("shortlink-stats-total-clicks-chart").getContext("2d");new Chart(e,{type:"doughnut",data:{datasets:[{data:[t],backgroundColor:["#5e72e4"],label:"Total Clicks"}],labels:["Total Clicks"]},options:{responsive:!0,elements:{center:{text:t,color:"#5e72e4",fontStyle:"Arial",sidePadding:40}}}});$("#shortlink-stats-total-clicks-number").text(t)}(s),function(t){var e=document.getElementById("shortlink-stats-today-clicks-chart").getContext("2d");new Chart(e,{type:"doughnut",data:{datasets:[{data:[t],backgroundColor:["#5e72e4"],label:"Today Clicks"}],labels:["Today Clicks"]},options:{responsive:!0,elements:{center:{text:t,color:"#5e72e4",fontStyle:"Arial",sidePadding:40}}}});$("#shortlink-stats-today-clicks-number").text(t)}(n),function(t){var e=[],s=[],n=[],a="";$.each(t,function(t,r){e.push(r.clicks),s.push(r.shortLink),n.push(i[t%10]),a+="<tr><td>"+(t+1)+"</td><td>"+r.shortLink+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-clicks-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:n}],labels:s},options:{responsive:!0}});$("#shortlink-stats-by-clicks-table tbody").html(a)}(a),function(t){var e=[],s=[],n=[],a="";$.each(t,function(t,r){e.push(r.clicks),s.push(r.referer),n.push(i[t%10]),a+="<tr><td>"+(t+1)+"</td><td>"+r.referer+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-referer-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:n}],labels:s},options:{responsive:!0}});$("#shortlink-stats-by-referer-table tbody").html(a)}(r),function(t){var e=[],s=[],n=[],a="";$.each(t,function(t,r){e.push(r.clicks),s.push(r.country),n.push(i[t%10]),a+="<tr><td>"+(t+1)+"</td><td>"+r.country+"</td><td>"+r.clicks+"</td></tr>"});var r=document.getElementById("shortlink-stats-by-country-chart").getContext("2d");new Chart(r,{type:"doughnut",data:{datasets:[{data:e,backgroundColor:n}],labels:s},options:{responsive:!0}});$("#shortlink-stats-by-country-table tbody").html(a)}(o)}else e='<div class="alert alert-danger alert-dismissible fade show" role="alert"><span class="alert-inner--text"><strong>Error!!</strong> '+t.message+'</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';$("#message-container").html(e)}),$("#jump-to-top").click(function(){$("html, body").animate({scrollTop:0},"slow")});var l,c=$(window).height();function d(t,e){var s="";"success"==e?s='<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button>'+t+"</div>":"error"==e?s='<div class="alert alert-danger alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button>'+t+"</div>":"info"==e&&(s='<div class="alert alert-info alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button>'+t+"</div>"),$("#messages").html(s)}function u(){d("Valid JSON received. Please navigate to <strong>Graphic</strong> Viewer screen to explore json","info");var t=function t(e,s,n){var a;1==s?(s=!1,a='<ul class="json-tree-root">'):a='<ul class="branch">';$.each(e,function(e,r){var o=typeof r,i=n+"."+e;a+="object"==o&&null!=r?'<li class="node"><span class="nodeElement tree-node-element-key" data-key-path="'+i+'">+ '+e+" {"+o+"}</span>"+t(r,s,i)+"</li>":null==r?'<li class="node"><span class="tree-node-element-key" data-key-path="'+i+'">'+e+"</span> : null {"+o+"</li>":'<li class="node"><span class="tree-node-element-key" data-key-path="'+i+'">'+e+"</span> : "+String(r).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")+" {"+o+"}</li>"});a+="</ul>";return a}(l,!0,"JSON");$("#tree-chart").html(t),l={}}c>$(window).scrollTop()?$("#jump-to-top").hide():$("#jump-to-top").show(),$(window).scroll(function(){c>$(window).scrollTop()?$("#jump-to-top").hide():$("#jump-to-top").show()}),"undefined"!=typeof hljs&&hljs.initHighlightingOnLoad(),$("#error-message").hide(),$("#format-code").click(function(){$("#error-message").hide();var t=$("#code-format-input-code").val(),e=$('.code-format-inputs input[name="input-resource-type"]:checked').val(),s=$('.code-format-inputs input[name="code-format-spacing"]:checked').val(),n=$("#code-format-use-tab").prop("checked");1==n?s=1:n=!1;var a={parser:e,tabWidth:parseInt(s),useTabs:n,singleQuote:!0,printWidth:500,plugins:prettierPlugins};$("html, body").animate({scrollTop:$("#formatted-code-box").offset().top-100},"slow");try{var r=prettier.format(t,a)}catch(t){var o=t.message;console.log(o.toString()),$("#error-message").text(o.toString()),$("#error-message").show()}$("#formatted-code").val(r),$("#copy-formatted-code").click(function(){$("#formatted-code").select(),document.execCommand("copy")})}),$("#json-url").keyup(function(){var t=$(this).val();d("We are fetching data from url","info"),$.ajax({url:t,type:"GET",success:function(t){d("Data fetched successfully","success");try{"string"==typeof t&&(t=JSON.parse(t)),l=t,$("#json-code").val(JSON.stringify(l)),u()}catch(t){d("It seems your json is not valid:  <strong>"+t+"</strong>","info")}},error:function(t){d("error",t)}})}),$("#json-code").keyup(function(){try{l=JSON.parse($(this).val()),u()}catch(t){d("It seems your json is not valid:  <strong>"+t+"</strong>","error")}}),$("#clear-fields").click(function(){$("#json-url").val(""),$("#json-code").val("")}),$(document).on("click",".nodeElement",function(){$(this).siblings(".branch").toggleClass("active")}),$(document).on("click",".tree-node-element-key",function(){$("#json-tree-node-path").text($(this).attr("data-key-path"))})});